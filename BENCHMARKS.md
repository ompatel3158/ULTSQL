...
This document presents verified empirical performance benchmarks comparing **UltSQL (`v1.0.21`)** against **SQLite 3**, **DuckDB**, and **ChromaDB**.

---

## 📊 Summary Scorecard

| Workload / Benchmark Metric | ⚡ UltSQL (`v1.0.21`) | 🪶 SQLite 3 | 🦆 DuckDB | 🧬 ChromaDB (Vector) |
| :--- | :--- | :--- | :--- | :--- |
