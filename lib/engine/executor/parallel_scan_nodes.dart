...
import 'package:hybrid_sql_engine/engine/cache/page.dart';
...
import 'package:hybrid_sql_engine/engine/executor/jit_compiler.dart';
              ...
              if (expr is FunctionCallExpr) {
                ...
                if (funcName == 'count' || funcName == 'sum') {
                  if (val1 is DbInt && val2 is DbInt) {
                    ...
                    final d1 = val1 is DbInt ? (val1 as DbInt).value.toDouble() : (val1 as DbDouble).value;
                    final d2 = val2 is DbInt ? (val2 as DbInt).value.toDouble() : (val2 as DbDouble).value;
